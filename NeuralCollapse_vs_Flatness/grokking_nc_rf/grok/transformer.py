...
class Transformer(nn.Module):
    ...
    def embed(self, indices: Tensor) -> Tensor:
        ...
        return pe + embedded # interesting here cause the positional embeddings are context_len * sequence len, but the embedded shape is [batch size x context_len x sequence len] 
